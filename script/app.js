var uri = "https://services.arcgis.com/rOo16HdIMeOBI4Mb/ArcGIS/rest/services/USA_Rail_Network/FeatureServer/0";
function runr(lat, lon) {
    ...
    // });
    // @ts-ignore
    var qwer = L.esri.Cluster.featureLayer({
        url: "https://services.arcgis.com/rOo16HdIMeOBI4Mb/arcgis/rest/services/Trimet_Transit_Stops/FeatureServer/0"
    }).addTo(map);
    qwer.bindPopup(function (e) {
        var zxcv = JSON.stringify(e.feature.properties)
            .split(",")
            .join("</div><div>");
